...
public class JoystickView extends View implements Runnable {
    ...
    public final static long DEFAULT_LOOP_INTERVAL = 1000;
    ...
    protected void initJoystickView() {
        ...
        mainCircle.setColor(Color.parseColor("#9C27B0"));
        mainCircle.setStyle(Paint.Style.STROKE);

        secondaryCircle = new Paint(Paint.ANTI_ALIAS_FLAG);
        secondaryCircle.setColor(Color.CYAN);
        secondaryCircle.setStyle(Paint.Style.FILL);

        verticalLine = new Paint();
        verticalLine.setStrokeWidth(2);
        verticalLine.setColor(Color.parseColor("#F44336"));

        horizontalLine = new Paint();
        horizontalLine.setStrokeWidth(2);
        horizontalLine.setColor(Color.parseColor("#4CAF50"));

        button = new Paint(Paint.ANTI_ALIAS_FLAG);
        button.setColor(Color.parseColor("#404040"));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle((int) centerX, (int) centerY, joystickRadius*0.4F, secondaryCircle);
        ...
        canvas.drawLine((float) centerX, (float) (centerY + joystickRadius), (float) centerX, (float) centerY, verticalLine);
        canvas.drawCircle(xPosition, yPosition, buttonRadius*0.7F, button);
    }
